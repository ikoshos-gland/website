    ...
    <div className="py-24 px-4 md:px-8 max-w-[1550px] mx-auto border-t border-[#23252B]">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 items-center">
        ...
        <div className="md:col-span-6 lg:col-span-5 order-2 md:order-1">
          ...
          <h2 className="font-instrument italic text-4xl md:text-6xl text-[#F5F5F5] mb-10 leading-none">
            My Story
          </h2>
          <div className="space-y-8 text-[#A1A1A6] text-xl md:text-2xl leading-relaxed font-light" style={{ fontFamily: '"Times New Roman", Times, serif' }}>
            <p>
        ...
        <div className="md:col-span-6 lg:col-span-7 order-1 md:order-2">
          <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#15171B] border border-[#23252B] md:rounded-sm">
            <img
